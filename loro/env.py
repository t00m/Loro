...
# Application
ENV['APP'] = {}
ENV['APP']['name'] = _('Language Learning App Helper')
ENV['APP']['shortname'] = 'Loro'
ENV['APP']['description'] = _('Language Learning Helper')
...
ENV['APP']['website'] = 'https://github.com/t00m/Loro'
...
# ~ # Common file paths
# ~ ENV['FILE'] = {}
# ~ ENV['FILE']['CONF'] = os.path.join(ENV['LPATH']['ETC'], 'Loro-application.json')
# ~ ENV['FILE']['VERSION'] = os.path.join(ENV['GPATH']['DOCS'], 'VERSION')
# ~ ENV['FILE']['APPICON'] = os.path.join(ENV['GPATH']['ICONS'], 'Loro.svg')
# ~ ENV['FILE']['LOG'] = os.path.join(ENV['LPATH']['LOG'], 'Loro.log')

...
class Editor(Gtk.Box):
    ...
    def _build_editor(self):
        ...
        self.btnWBAdd = self.factory.create_button(icon_name='document-new-symbolic', tooltip='Add a new workbook', callback=self._add_workbook)
        self.btnWBEdit = self.factory.create_button(icon_name='document-edit-symbolic', tooltip='Edit workbook name', callback=self._edit_workbook)
        self.btnWBDel = self.factory.create_button(icon_name='user-trash-symbolic', tooltip='Delete selected workbook', callback=self._delete_workbook)
        ...
        self.btnRename = self.factory.create_button(icon_name='document-edit-symbolic', tooltip='Rename document', callback=self._rename_document)
        ...
        self.btnDelete = self.factory.create_button(icon_name='user-trash-symbolic', tooltip='Delete doc', callback=self._delete_document)
        expander = Gtk.Box(spacing=6, orientation=Gtk.Orientation.HORIZONTAL, hexpand=True)
